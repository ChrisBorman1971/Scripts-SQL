...
BACKUP DATABASE [TA_SEPFinance] TO  DISK = N'G:\Backups\TA_SEPFinance_backup_Pre_TDE_2012_09_17_141000.fbak' WITH NOFORMAT, INIT,  NAME = N'TA_SEPFinance-Full Database Backup', SKIP, NOREWIND, NOUNLOAD, COMPRESSION,  STATS = 10
GO
...
RESTORE VERIFYONLY FROM  DISK = N'G:\Backups\TA_SEPFinance_backup_Pre_TDE_2012_09_17_141000.fbak' WITH  FILE = @backupSetId,  NOUNLOAD,  NOREWIND
GO

-- STEP 2 - Backup the master database prior to setting up 
BACKUP DATABASE [master] TO  DISK = N'G:\Backups\master_backup_Pre_TDE_2012_09_17_141000.fbak' WITH NOFORMAT, INIT,  NAME = N'master-Full Database Backup', SKIP, NOREWIND, NOUNLOAD, COMPRESSION,  STATS = 10
GO
declare @backupSetId as int
...
RESTORE VERIFYONLY FROM  DISK = N'G:\Backups\master_backup_Pre_TDE_2012_09_17_141000.fbak' WITH  FILE = @backupSetId,  NOUNLOAD,  NOREWIND
GO
...
TO FILE = '\\mstfs01\IT\Operations\DBA\Environment\SQL Server\TDE\TDECertificates\MSTVMSQL02\CertificateforTDE_TA_Teachers.cer'
WITH PRIVATE KEY (FILE = '\\mstfs01\IT\Operations\DBA\Environment\SQL Server\TDE\TDECertificates\MSTVMSQL02\CertificateforTDE_TA_Teachers.key'
...
BACKUP MASTER KEY TO FILE = '\\mstfs01\IT\Operations\DBA\Environment\SQL Server\TDE\TDECertificates\MSTVMSQL02\ExportedMasterKey.key'
