...
BACKUP DATABASE [TA_SEPFinance] TO  DISK = N'\\veeam1\SQLBackup\MSTTESTDB18\TA_SEPFinance_backup_Pre_TDE_2012_11_01_140000.fbak' WITH NOFORMAT, INIT,  NAME = N'TA_SEPFinance-Full Database Backup', SKIP, NOREWIND, NOUNLOAD, COMPRESSION,  STATS = 10
GO
...
RESTORE VERIFYONLY FROM  DISK = N'\\veeam1\SQLBackup\MSTTESTDB18\TA_SEPFinance_backup_Pre_TDE_2012_11_01_140000.fbak' WITH  FILE = @backupSetId,  NOUNLOAD,  NOREWIND
GO

-- STEP 2 - Backup the master database prior to setting up 

BACKUP DATABASE [master] TO  DISK = N'\\veeam1\SQLBackup\MSTTESTDB18\master_backup_Pre_TDE_2012_11_01_140000.fbak' WITH NOFORMAT, INIT,  NAME = N'master-Full Database Backup', SKIP, NOREWIND, NOUNLOAD, COMPRESSION,  STATS = 10
GO
declare @backupSetId as int
...
RESTORE VERIFYONLY FROM  DISK = N'\\veeam1\SQLBackup\MSTTESTDB18\master_backup_Pre_TDE_2012_11_01_140000.fbak' WITH  FILE = @backupSetId,  NOUNLOAD,  NOREWIND
GO
...
CREATE MASTER KEY ENCRYPTION BY PASSWORD = 'TEST_M45t3r#K3yEncrypt!0n##~~##'
GO 
...
WITH SUBJECT = 'CertificateforTDE_TA_Teachers', EXPIRY_DATE = '20420101'
GO
...
TO FILE = '\\mstfs01\IT\Operations\DBA\Environment\SQL Server\TDE\TDECertificates\MSTTESTDB18\TEST_CertificateforTDE_TA_Teachers.cer'
WITH PRIVATE KEY (FILE = '\\mstfs01\IT\Operations\DBA\Environment\SQL Server\TDE\TDECertificates\MSTTESTDB18\TEST_CertificateforTDE_TA_Teachers.key'
                 ,ENCRYPTION BY PASSWORD  = 'TEST_C3rt!f1c4t3f0rTDE#TA#Teachers1#~')
GO 
...
OPEN MASTER KEY DECRYPTION BY PASSWORD = 'TEST_M45t3r#K3yEncrypt!0n##~~##'
BACKUP MASTER KEY TO FILE = '\\mstfs01\IT\Operations\DBA\Environment\SQL Server\TDE\TDECertificates\MSTTESTDB18\ExportedMasterKey.key'
ENCRYPTION BY PASSWORD = 'TEST_Exp0rt3dM45t3rK3y1!#~'
GO
