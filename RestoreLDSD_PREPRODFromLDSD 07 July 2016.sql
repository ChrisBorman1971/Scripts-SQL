-- RestoreLDSD_PREPRODFromLDSD.sql     WH    06/07/16
--
...
-- Let them back in
ALTER DATABASE [LDSD_PREPROD] SET MULTI_USER WITH NO_WAIT;

-- Not sure why LDSDADMIN lost db_owner on LDSD

USE [LDSD]; --Shouldnt this be LDSD_PREPROD?
...
-------------------------------------------------------------------------------------------------------------------------------
/*Once Graham Gives the Go Ahead run the script UpdateMultiAttachmentField_Request against LDSD live database on the server XSW-000-SP02*/
