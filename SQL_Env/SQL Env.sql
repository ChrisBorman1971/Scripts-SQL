...
Insert into #ProdVer
	(ProductVersion)
	(select left(cast(SERVERPROPERTY('productversion') as varchar),1))
Go

-- Create Temporary Table for the SQL Logins 
CREATE TABLE #SQLLogins
	(
		[Server_ID] [int] NOT NULL,
		[ServerName] [nvarchar](50) NULL,
		[loginname] [nvarchar](75) NULL,
		[type_desc1] [nvarchar](5) NULL,
		[type_desc2] [nvarchar](25) NULL,
		[is_disabled] [int] NULL,
		[created] [varchar](20) NULL, -- datetime Null,
		[update] [varchar](20) NULL, -- datetime Null,
		[hasaccess] [int] NULL,
		[isntname] [int] NULL,
		[isntgroup] [int] NULL,
		[isntuser] [int] NULL,
