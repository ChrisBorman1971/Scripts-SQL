...
Declare @TempTemp char(2)
Declare @posttemp int

Set @TempTemp = (Select ProductVersion from #ProdVer)
...
If @TempTemp = '10' or @TempTemp = '11' or @TempTemp = '12' or @TempTemp = '13'    
	Set @posttemp = @TempTemp
...
-- Create Temporary Table for the SQL Env Data
...
CREATE TABLE #SQLServers
	(
		...
		[dbid] [int] NULL,
		[Product_Version] [nvarchar](25) NULL,
		[Product_Level] [nvarchar](5) NULL,
		[EditionInstalled] [nvarchar](30) NULL,
		[OSVersion] [nvarchar](30) NULL,
		[Collation_Type] [nvarchar](30) NULL,
		[IsClustered?] [int] NULL,
		[Authentication Mode] [nvarchar](50) NULL,
		[dbName] [nvarchar](50) NULL,
		[Status] [nvarchar](10) NULL,
		[User Access] [nvarchar](25) NULL,
		[Recovery Model] [nvarchar](10) NULL,
		[cmptlevel] [nvarchar](25) NULL,
		[fileid] [int] NULL,
		[type_desc] [nvarchar](10) NULL,
		[filename] [nvarchar](100) NULL,
		[Creation date] [datetime] NULL,
		[Last backup] [nvarchar](100) NULL,
		[fulltext] [nvarchar](25) NULL,
		[autoclose] [nvarchar](10) NULL,
		[page verify option] [nvarchar](20) NULL,
		[read only] [nvarchar](10) NULL,
		[autoshrink] [nvarchar](10) NULL,
		[auto create statistics] [nvarchar](25) NULL,
		[auto update statistics] [nvarchar](25) NULL,
		[standby] [nvarchar](10) NULL,
		[cleanly shutdown] [nvarchar](25) NULL
	) 
